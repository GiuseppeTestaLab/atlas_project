...
model.save("/group/testa/Project/OvarianAtlas/atlas_project/raw_data/integration/metacells/saved_models/fibroblasts_batch_removal_tissuetreatment.pt", overwrite=True)
...
sc.pl.umap(adata, color=["tissue-treatment"], frameon=False, save='fibroblasts_seacells_HDG_tissue-treat.png')
