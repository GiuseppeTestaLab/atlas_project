...
sc.settings.figdir = "/group/testa/Project/OvarianAtlas/atlas_project/plots_def/integration/metacells/endothelial/"
...
sc.pl.embedding(adata, basis="X_mde", color=["tissue-treatment"], frameon=False, ncols=1)
