# Integration (preserving tissues and treatment) of endothelial seacells generated in the HDG space with prior HDG space selection
...
model.save("/group/testa/Project/OvarianAtlas/atlas_project/raw_data/integration/metacells/saved_models/endothelial_batch_removal_tissuetreatment_HDG.pt", overwrite=True)
...
#%%
sc.pl.umap(adata, color=["treatment"], frameon=False, save='endothelial_seacells_HDG_treatm_HDG.png')
sc.pl.umap(adata, color=["tissue"], frameon=False, save='endothelial_seacells_HDG_tissue_HDG.png')
sc.pl.umap(adata, color=["dataset"], frameon=False, save='endothelial_seacells_HDG_dataset_HDG.png')
sc.pl.umap(adata, color=["paper_ID"], frameon=False, save='endothelial_seacells_HDG_patients_HDG.png')
sc.pl.umap(adata, color=["phase"], frameon=False, save='endothelial_seacells_HDG_cellcycle_HDG.png')
sc.pl.umap(adata, color=["tissue-treatment"], frameon=False, save='endothelial_seacells_HDG_tissue-treat_HDG.png')
