# Integration (preserving tissues and treatment) of endothelial seacells generated in the HDG space
...
#%%
sc.pl.umap(adata, color=["treatment"], frameon=False, save='endothelial_seacells_treatm_2500.png')
sc.pl.umap(adata, color=["tissue"], frameon=False, save='endothelial_seacells_tissue_2500.png')
sc.pl.umap(adata, color=["dataset"], frameon=False, save='endothelial_seacells_dataset_2500.png')
sc.pl.umap(adata, color=["paper_ID"], frameon=False, save='endothelial_seacells_patients_2500.png')
sc.pl.umap(adata, color=["phase"], frameon=False, save='endothelial_seacells_cellcycle_2500.png')
sc.pl.umap(adata, color=["tissue-treatment"], frameon=False, save='endothelial_seacells_tissuetreat_2500.png')
