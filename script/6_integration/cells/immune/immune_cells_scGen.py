...
outDir = '/group/testa/Project/OvarianAtlas/atlas_project/raw_data/integration/cells/immune/'
#%%
...
#%%
sc.pl.umap(adata, color=["treatment"], frameon=False, save='immune_cells_treatm.png')
sc.pl.umap(adata, color=["tissue"], frameon=False, save='immune_cells_tissue.png')
sc.pl.umap(adata, color=["dataset"], frameon=False, save='immune_cells_dataset.png')
sc.pl.umap(adata, color=["paper_ID"], frameon=False, save='immune_cells_patients.png')
sc.pl.umap(adata, color=["phase"], frameon=False, save='immune_cells_cellcycle.png')
sc.pl.umap(adata, color=["tissue-treatment"], frameon=False, save='immune_cells_tissue-treat.png')
sc.pl.umap(adata, color=["cell_types"], frameon=False, save='immune_cells_HDG_celltypes.png')
