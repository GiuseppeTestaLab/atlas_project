# Testing scib metrcis on immune cells with scvi implementation of scib 
...
initDir = rawPath + 'integration/cells/immune/'
...
adata_first.write_h5ad(initDir + 'cells_immune_batch_corr_metrics.h5ad')