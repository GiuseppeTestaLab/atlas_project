...
#%%
sc.pl.umap(adata, color=["treatment"], frameon=False, save='endothelial_cells_treatm.png')
sc.pl.umap(adata, color=["tissue"], frameon=False, save='endothelial_cells_tissue.png')
sc.pl.umap(adata, color=["dataset"], frameon=False, save='endothelial_cells_dataset.png')
sc.pl.umap(adata, color=["paper_ID"], frameon=False, save='endothelial_cells_patients.png')
sc.pl.umap(adata, color=["phase"], frameon=False, save='endothelial_cells_cellcycle.png')
sc.pl.umap(adata, color=["tissue-treatment"], frameon=False, save='endothelial_cells_tissue-treat.png')

#%%
adata.write(outDir + 'scgen_batch_corr_tissue-treatment_embeddings.h5ad')
