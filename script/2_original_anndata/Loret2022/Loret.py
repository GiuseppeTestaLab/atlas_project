...
dir = '/group/testa/Project/OvarianAtlas/atlas_project/raw_data/original_anndata/Loret2022/'

#Read adata
adata = sc.read(dir + "loret2022_filt_norm_nolog.h5ad")
...
adata.write(dir + 'loret2022_embeddings.h5ad')
