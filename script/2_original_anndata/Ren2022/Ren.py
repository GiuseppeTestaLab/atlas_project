...
dir = '/group/testa/Project/OvarianAtlas/atlas_project/raw_data/original_anndata/Ren2022/'

#Read adata
adata = sc.read(dir + "ren2022_filt_norm_nolog.h5ad")
...
adata.write(dir + 'ren2022_embeddings.h5ad')
