...
dir = '/group/testa/Project/OvarianAtlas/atlas_project/raw_data/original_anndata/Vasquez2022/'

#Read adata
adata = sc.read(dir + "vasquez2022_filt_norm_nolog.h5ad")
...
adata.write(dir + 'vasquez2022_embeddings.h5ad')
