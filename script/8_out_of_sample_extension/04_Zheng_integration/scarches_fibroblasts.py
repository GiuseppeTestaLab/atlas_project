...
#%%
adata_target = sc.read_h5ad('/group/testa/Project/OvarianAtlas/Zheng2023/Metacells/fibroblasts_seacells_hdg_patients.h5ad')
...
adataX = adataX.T
adataX['ZBTB20-AS2'] = adataX['MT-CO3']*0
adataX['OTUD6A'] = adataX['MT-CO3']*0
