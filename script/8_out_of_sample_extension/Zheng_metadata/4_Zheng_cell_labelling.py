...
#%%
adata = sc.read("/group/testa/Project/OvarianAtlas/Zheng2023/Adata/zheng2023_embeddings.h5ad")
...
score_name = "CancerMSK", use_raw=False)
...
score_name = "EndothelialMSK", use_raw=False)
...
score_name = "FibroblastsMSK", use_raw=False)

sc.tl.score_genes(adata, 
['PTPRC'], 
score_name = "HematopoieticMSK", use_raw=False)
...
#%%
adata.write('/group/testa/Project/OvarianAtlas/Zheng2023/Adata/zheng2023_embeddings_cell_labelled.h5ad')