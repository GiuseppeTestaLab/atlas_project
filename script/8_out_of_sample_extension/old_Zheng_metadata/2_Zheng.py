...
#inputs
#%%
initDir = "/group/testa/Project/OvarianAtlas/Zheng2023/" 
outDir = "/group/testa/Project/OvarianAtlas/Zheng2023/Adata/"
min_genes = 200
min_cells = 3
genes_by_counts = 7000
pct_counts_mt = 8
target_sum=1e4
...
#create anndata
#%%
adata = sc.read_mtx("/group/testa/Project/OvarianAtlas/Zheng2023/Counts/counts.mtx")
adata
#%%
...
#%%
var = pd.read_csv("/group/testa/Project/OvarianAtlas/Zheng2023/Counts/var_names.csv", index_col=0)
var.columns
var.columns[0]
...
# Creating metadata
#%%
meta = pd.read_csv("/group/testa/Project/OvarianAtlas/Zheng2023/Counts/metadata.csv", index_col=0)
adata.obs = meta 
...
adata.write_h5ad(outDir + "zheng2023_wholedataset_rawcounts.h5ad")
...
adata.write(outDir + "zheng2023_wholedataset_filt_norm_nolog.h5ad")
...
adata.write(outDir + "zheng2023_wholedataset_embeddings.h5ad")
#%%
#Remove blood, lymph nodes and all non-HGSOC cancer types
adata = sc.read(outDir + "zheng2023_wholedataset_rawcounts.h5ad")
#%%
...
adata.write(outDir + "zheng2023_rawcounts.h5ad")
#%%
##Preprocessing
...
adata.write(outDir + "zheng2023_filt_norm_nolog.h5ad")
...
adata.write(outDir + "zheng2023_embeddings.h5ad")
