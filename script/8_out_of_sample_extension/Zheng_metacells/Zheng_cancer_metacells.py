...
## Load data
#%%
adata= sc.read("/group/testa/Project/OvarianAtlas/Zheng2023/Adata/zheng_cancer_filt_norm_nolog.h5ad")
...
adata.write_h5ad('/group/testa/Project/OvarianAtlas/Zheng2023/Metacells/cancer_seacells_assignment_hdg_patients.h5ad')