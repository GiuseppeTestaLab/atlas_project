# Zheng immune metacells generation
...
## Load data
#%%
adata= sc.read("/group/testa/Project/OvarianAtlas/Zheng2023/Adata/zheng_immune_filt_norm_nolog.h5ad")
genes = '/home/marta.sallese/ov_cancer_atlas/Atlas_scripts/HDG_new/Tables/atlas_hdg_dispersion_patients_immune.csv'
...
adata.raw = raw_ad
sc.pp.log1p(adata)
hdg = pd.read_csv('/home/marta.sallese/ov_cancer_atlas/Atlas_scripts/HDG_new/Tables/atlas_hdg_dispersion_patients_immune.csv',  index_col=0)
...
sc.tl.umap(adata)
#adata.write_h5ad('/group/testa/Project/OvarianAtlas/Zheng2023/Adata/zheng_immune_embeddings.h5ad')

## Metacells generation per patient
#%%
#%%
adata = assign_metacells(adata)
adata.write_h5ad(destDir + 'immune_seacells_assignment_hdg_patients.h5ad')

# Creating metacell matrix
#%%
adata = sc.read(destDir + 'immune_seacells_assignment_hdg_patients.h5ad')
...
ad.write(destDir + 'immune_seacells_hdg_patients.h5ad')

#%%
## Compute embeddings and plot metacells
adata = sc.read(destDir + 'immune_seacells_hdg_patients.h5ad')
...
#%%
adata.write(destDir + 'immune_seacells_hdg_patients_embeddings.h5ad')