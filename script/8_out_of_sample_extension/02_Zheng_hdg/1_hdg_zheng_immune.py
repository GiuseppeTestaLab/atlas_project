...
adata_immune.write(initDir + 'zheng2023_adata_immune.h5ad')
...
for j in dataName:
    path = (dataDir + j.capitalize() + '/Adata' + "/{}_adata_immune.h5ad").format(j)
    print(path)
...
dispersion_table.to_csv(scriptsPath + '4_hdg/Tables/dispersion_table_immune_zheng.csv')
hvg_table.to_csv(scriptsPath + '4_hdg/Tables/hvg_table_immune_zheng.csv')

# 2_hvg_union_patients_dispersion_immune zheng
## Computing HDG by patient based on dispersion values

dir = scriptsPath + '4_hdg/Tables/'
#%%
dispersion_table = pd.read_csv(scriptsPath + '4_hdg/Tables/dispersion_table_immune_zheng.csv', index_col=0)
...
#%%
hdg_table.to_csv(dir + 'atlas_hdg_common_dispersion_patients_immune_zheng.csv')

#%%
hdg_true = pd.DataFrame(index=list_of_genes)
hdg_true['highly_variable'] = "True"
hdg_true.to_csv(dir + 'atlas_hdg_dispersion_patients_immune_zheng.csv')
