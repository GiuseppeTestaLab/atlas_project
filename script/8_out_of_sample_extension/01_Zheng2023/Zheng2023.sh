...
singularity exec -B $bindPaths -H $homePath $image \
                 /bin/bash -c "eval \"\$(conda shell.bash hook)\" && conda activate ovarian && \
                 python3 01_Zheng2023/1_Zheng.py && \
                 python3 01_Zheng2023/2_Zheng_cell_labelling.py && \
                 python3 01_Zheng2023/3_Zheng_cell_subsets.py"
