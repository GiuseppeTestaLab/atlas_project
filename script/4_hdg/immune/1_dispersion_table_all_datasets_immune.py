...
adata_immune.write(commonDir + 'Geistlinger2020/geistlinger2020_adata_immune.h5ad')
...
adata_immune.write(commonDir + 'Regner2021/regner2021_adata_immune.h5ad')
...
adata_immune.write(commonDir + 'Loret2022/loret2022_adata_immune.h5ad')
...
adata_immune.write(commonDir + 'Olbrecht2021/olbrecht2021_adata_immune.h5ad')
...
adata_immune.write(commonDir + 'Qian2020/qian2020_adata_immune.h5ad')
...
adata_immune.write(commonDir + 'Ren2022/ren2022_adata_immune.h5ad')
...
adata_immune.write(commonDir + 'Xu2022/xu2022_adata_immune.h5ad')
...
adata_immune.write(commonDir + 'Zhang2022/zhang2022_adata_immune.h5ad')
...
adata_immune.write(commonDir + 'Vasquez2022/vasquez2022_adata_immune.h5ad')
...
for j in dataName:
    ...
    for patient_code in adata_immune.obs["paper_ID"].unique():
        patient_anndata = adata_immune[adata_immune.obs["paper_ID"] == patient_code].copy()
...
dispersion_table.to_csv('/home/marta.sallese/ov_cancer_atlas/Atlas_scripts/HDG_new/Tables/dispersion_table_immune.csv')
hvg_table.to_csv('/home/marta.sallese/ov_cancer_atlas/Atlas_scripts/HDG_new/Tables/hvg_table_immune.csv')
