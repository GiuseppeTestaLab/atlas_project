...
"/bin/python3 ${scriptsPath}4_hdg/cancer/1_dispersion_table_all_datasets_immune.py"
...
# "/bin/python3 /home/marta.sallese/ov_cancer_atlas/atlas_project/script/4_hdg/immune/1_dispersion_table_all_datasets_immune.py"