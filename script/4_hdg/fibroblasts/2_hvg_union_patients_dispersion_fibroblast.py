...
filtered_df = dispersion_table[dispersion_table > 2.25].dropna(how="all")  # 5179 genes
...
# %%
hdg_table.to_csv(dir + "atlas_hdg_common_dispersion_patients_fibroblasts.csv")

# %%
hdg_true = pd.DataFrame(index=list_of_genes)
hdg_true["highly_variable"] = "True"
hdg_true.to_csv(dir + "atlas_hdg_dispersion_patients_fibroblasts.csv")
# %%
