...
"/bin/python3 ${scriptsPath}4_hdg/endothelial/1_dispersion_table_all_datasets_endothelial.py"
...
# "/bin/python3 /home/marta.sallese/ov_cancer_atlas/atlas_project/script/4_hdg/endothelial/1_dispersion_table_all_datasets_endothelial.py"