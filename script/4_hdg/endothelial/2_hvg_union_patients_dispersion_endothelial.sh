...
"/bin/python3 ${scriptsPath}4_hdg/endothelial/2_hvg_union_patients_dispersion_endothelial.py"
...
# "/bin/python3 /home/marta.sallese/ov_cancer_atlas/atlas_project/script/4_hdg/endothelial/2_hvg_union_patients_dispersion_endothelial.py"