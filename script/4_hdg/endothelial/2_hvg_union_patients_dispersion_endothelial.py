...
# %%
#filtered_df = dispersion_table[dispersion_table > ].dropna(how='all')  # 5002 genes
filtered_df = dispersion_table[dispersion_table > 1.98].dropna(how='all')  # 5096 genes
...
#%%
hdg_table.to_csv(dir + 'atlas_hdg_common_dispersion_patients_endothelial.csv')

#%%
hdg_true = pd.DataFrame(index=list_of_genes)
hdg_true['highly_variable'] = "True"
hdg_true.to_csv(dir + 'atlas_hdg_dispersion_patients_endothelial.csv')
# %%
