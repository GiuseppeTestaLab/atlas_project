...
# common_var_names = pd.read_csv('/home/marta.sallese/ov_cancer_atlas/Atlas_project/script/hdg/Tables/common_varnames_datasets.csv', index_col=0) #this file is derived from common_var_names.py
...
# adata_cancer.write(commonDir + 'Geistlinger2020/geistlinger2020_adata_cancer.h5ad')
...
# adata_cancer.write(commonDir + 'Regner2021/regner2021_adata_cancer.h5ad')
...
# adata_cancer.write(commonDir + 'Loret2022/loret2022_adata_cancer.h5ad')
...
# adata_cancer.write(commonDir + 'Olbrecht2021/olbrecht2021_adata_cancer.h5ad')
...
# adata_cancer.write(commonDir + 'Qian2020/qian2020_adata_cancer.h5ad')
...
# adata_cancer.write(commonDir + 'Ren2022/ren2022_adata_cancer.h5ad')
...
# adata_cancer.write(commonDir + 'Xu2022/xu2022_adata_cancer.h5ad')
...
# adata_cancer.write(commonDir + 'Zhang2022/zhang2022_adata_cancer.h5ad')
...
# adata_cancer.write(commonDir + 'Vasquez2022/vasquez2022_adata_cancer.h5ad')
...
dispersion_table.to_csv('/home/marta.sallese/ov_cancer_atlas/Atlas_scripts/HDG_new/Tables/dispersion_table_cancer.csv')
hvg_table.to_csv('/home/marta.sallese/ov_cancer_atlas/Atlas_scripts/HDG_new/Tables/hvg_table_cancer.csv')
