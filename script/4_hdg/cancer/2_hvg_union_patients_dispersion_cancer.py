...
#%%
dispersion_table = pd.read_csv('/home/marta.sallese/ov_cancer_atlas/atlas_project/script/hdg/Tables/dispersion_table_cancer.csv', index_col=0)
...
#%%
hdg_table.to_csv('/home/marta.sallese/ov_cancer_atlas/atlas_project/script/hdg/Tables/atlas_hdg_common_dispersion_patients_cancer.csv')

#%%
hdg_true = pd.DataFrame(index=list_of_genes)
hdg_true['highly_variable'] = "True"
hdg_true.to_csv('/home/marta.sallese/ov_cancer_atlas/atlas_project/script/hdg/Tables/atlas_hdg_dispersion_patients_cancer.csv')
# %%
