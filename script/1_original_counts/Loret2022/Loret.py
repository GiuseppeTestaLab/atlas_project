...
parameters = pd.read_csv(
    scriptsPath + "1_original_counts/Loret2022/preprocess_params.tsv", sep=";"
)
...
for i in listpath:
    ...
    adata[counteradata].obs["cell"] = (
        adata[counteradata].obs.index + "-" + adata[counteradata].obs["ID"]
    )
