...
#inputs
parameters = pd.read_csv(scriptsPath+ "1_original_counts/Zhang2022/preprocess_params.tsv", sep = ';')
...
columns['sample_name'] = {"EOC372_primary_Peritoneum": "GSM5057586", 
...
columns['tissue'] = {"EOC372_primary_Peritoneum": "Metastasis", 
...
columns['developmental_stage'] = {"EOC372_primary_Peritoneum": "Advanced stage", 
...
columns['recurrence'] = {"EOC372_primary_Peritoneum": "Sensitive", 
...
columns['tumor_stage'] = {"EOC372_primary_Peritoneum": "IIIC", 
...
columns['paper_ID'] = {"EOC372_primary_Peritoneum": "Zhang_372", 
...
adata.obs = adata.obs[["ID", "patient_id", "sample_name", "tissue", "developmental_stage", 
                       "treatment", "recurrence", "tumor_stage", "paper_ID", 
                       "anatomical_location", "dataset", "cell_type", "cell_subtype"]]
