...
#%%
ad = sc.read_h5ad("/group/testa/Project/OvarianAtlas/atlas_project/raw_data/metacells_backup/metacells/endothelial/" + "seacells_hdg_patients.h5ad")
...
#%%
ref_path = rawPath + 'integration/metacells/saved_models/endothelial_batch_removal_tissuetreatment_scarches'
...
#%%
adata_target_path = "/group/testa/Project/OvarianAtlasTestStep0/raw_data/metacells_step0/endothelial/" + 'seacells_hdg_patients.h5ad'
...
#%%
genes = pd.read_csv(scriptsPath + '4_hdg/Tables/atlas_hdg_dispersion_patients_endothelial.csv', index_col=0)
