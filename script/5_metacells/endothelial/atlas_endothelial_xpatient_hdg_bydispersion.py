...
adata.raw = raw_ad
sc.pp.log1p(adata)
hdg = pd.read_csv('/home/marta.sallese/ov_cancer_atlas/atlas_project/script/hdg/endothelial/atlas_hdg_dispersion_patients_endothelial.csv',  index_col=0)
...
adata.write_h5ad(destDir + 'atlas_seacells_assignment_hdg_patients_endothelial.h5ad')

## Creating metacell matrix
#%%
# adata = sc.read(destDir + 'atlas_seacells_assignment_hdg_patients_endothelial.h5ad')
...
#%%
ad.write(destDir + 'atlas_endothelial_seacells_hdg_patients.h5ad')

## Compute embeddings and plot metacells

#%%
adata = sc.read(destDir + 'atlas_endothelial_seacells_hdg_patients.h5ad')
...
#%%
adata.write(destDir + 'atlas_endothelial_seacells_hdg_patients_embeddings.h5ad')