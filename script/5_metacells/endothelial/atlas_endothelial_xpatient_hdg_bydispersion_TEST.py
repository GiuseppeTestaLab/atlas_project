...
from metacells_derivation_TEST import preprocess, assign_metacells, create_mc_matrix, preprocess_mc

#%%
initDir = '/group/testa/Project/OvarianAtlas/atlas_project/raw_data/atlas_annotated_backup/atlas_annotated/'
destDir = '/group/testa/Project/OvarianAtlas/atlas_project/raw_data/metacells_backup/metacells/endothelial/'
...
adata.write_h5ad(initDir + 'atlas_endothelial_embeddings_TEST270225.h5ad')

## Metacells generation per patient
#%%
adata = assign_metacells(adata)
adata.write_h5ad(destDir + 'seacells_assignment_hdg_patients_TEST270225.h5ad')
