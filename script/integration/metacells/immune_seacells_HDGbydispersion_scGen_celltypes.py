...
#%%
scgen.SCGEN.setup_anndata(train, batch_key="paper_ID", labels_key="cell_types")

#%%
model = scgen.SCGEN(train)
model.save("/group/testa/Project/OvarianAtlas/atlas_project/raw_data/integration/metacells/saved_models/model_seacells_immune_batch_removal_celltypes.pt", overwrite=True)
...
corrected_adata.write_h5ad('/group/testa/Project/OvarianAtlas/atlas_project/raw_data/integration/metacells/seacells_immune_hdg_patients_batch_corr_scgen_celltypes.h5ad')