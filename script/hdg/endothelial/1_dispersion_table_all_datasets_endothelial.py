...
adata_endo.write(commonDir + 'Geistlinger2020/geistlinger2020_adata_endothelial.h5ad')
...
adata_endo.write(commonDir + 'Regner2021/regner2021_adata_endothelial.h5ad')
...
adata_endo.write(commonDir + 'Loret2022/loret2022_adata_endothelial.h5ad')
...
adata_endo.write(commonDir + 'Olbrecht2021/olbrecht2021_adata_endothelial.h5ad')
...
adata_endo.write(commonDir + 'Qian2020/qian2020_adata_endothelial.h5ad')
...
adata_endo.write(commonDir + 'Ren2022/ren2022_adata_endothelial.h5ad')
...
adata_endo.write(commonDir + 'Xu2022/xu2022_adata_endothelial.h5ad')
...
adata_endo.write(commonDir + 'Zhang2022/zhang2022_adata_endothelial.h5ad')
...
adata_endo.write(commonDir + 'Vasquez2022/vasquez2022_adata_endothelial.h5ad')
...
dispersion_table.to_csv('/home/marta.sallese/ov_cancer_atlas/Atlas_scripts/HDG_new/Tables/dispersion_table_endothelial.csv')
hvg_table.to_csv('/home/marta.sallese/ov_cancer_atlas/Atlas_scripts/HDG_new/Tables/hvg_table_endothelial.csv')
