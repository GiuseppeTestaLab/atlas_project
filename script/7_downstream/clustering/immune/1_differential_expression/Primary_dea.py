# Clustering and cell states annotation of immune seacells from primary tissue
...
sc.pl.umap(adata_pr, color=["cell_types", "cell_subtypes"], frameon=False)
...
# #%%
# directory_root = "/group/testa/Project/OvarianAtlas/atlas_project/raw_data/downstream/clustering/immune/primary/"
