# Clustering and cell states annotation of immune seacells from metastatic tissue
...
outDir = '/group/testa/Project/OvarianAtlas/atlas_project/raw_data/downstream/clustering/immune/'
...
sc.pl.umap(adata_mt, color=["cell_types", "cell_subtypes"], frameon=False)
...
# #%%
# directory_root = "/group/testa/Project/OvarianAtlas/atlas_project/raw_data/downstream/clustering/immune/metastasis/"
