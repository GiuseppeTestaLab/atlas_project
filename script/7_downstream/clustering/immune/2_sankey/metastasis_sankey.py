...
initDir = '/group/testa/Project/OvarianAtlas/atlas_project/raw_data/downstream/clustering/immune/'
...
fig.write_image(figDir + 'immune_metastasis_leiden.png')
fig.write_html(figDir + 'immune_metastasis_leiden.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'immune_metastasis_treatment.png')
fig.write_html(figDir + 'immune_metastasis_treatment.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'immune_metastasis_cellcycle.png')
fig.write_html(figDir + 'immune_metastasis_cellcycle.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'immune_metastasis_recurrence.png')
fig.write_html(figDir + 'immune_metastasis_recurrence.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'immune_metastasis_anatomical_location.png')
fig.write_html(figDir + 'immune_metastasis_anatomical_location.html')
fig.show()
