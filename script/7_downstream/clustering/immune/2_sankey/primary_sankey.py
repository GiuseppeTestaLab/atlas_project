...
fig.write_image(figDir + 'immune_primary_leiden.png')
fig.write_html(figDir + 'immune_primary_leiden.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'immune_primary_treatment.png')
fig.write_html(figDir + 'immune_primary_treatment.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'immune_primary_cellcycle.png')
fig.write_html(figDir + 'immune_primary_cellcycle.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'immune_primary_tumorstage.png')
fig.write_html(figDir + 'immune_primary_tumorstage.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'immune_primary_recurrence.png')
fig.write_html(figDir + 'immune_primary_recurrence.html')
fig.show()
