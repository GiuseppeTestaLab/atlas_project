...
fig.write_image(figDir + 'endothelial_ascites_leiden.png')
fig.write_html(figDir + 'endothelial_ascites_leiden.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'endothelial_ascites_treatment.png')
fig.write_html(figDir + 'endothelial_ascites_treatment.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'endothelial_ascites_cellcycle.png')
fig.write_html(figDir + 'endothelial_ascites_cellcycle.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'endothelial_ascites_tumorstage.png')
fig.write_html(figDir + 'endothelial_ascites_tumorstage.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'endothelial_ascites_recurrence.png')
fig.write_html(figDir + 'endothelial_ascites_recurrence.html')
fig.show()
