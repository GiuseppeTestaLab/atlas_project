...
## loading data
#%%
# old = sc.read(initDir + 'seacells_hdg_patients_batch_corr_scgen_tissuetreat_embeddings.h5ad')
...
#%%
directory_root = "/group/testa/Project/OvarianAtlas/atlas_project/raw_data/downstream/clustering/endothelial/primary/"
