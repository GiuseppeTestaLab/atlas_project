...
sc.pl.umap(primary, color=['leiden-0.51'], frameon=False, save='_priamry_leiden051.png')
...
col = { "0":"Immunoreactive_cells-T_cells", 
        ...
        "14":"Unknown_metastasis_14",
        "15":"Unknown_metastasis_15"} 
