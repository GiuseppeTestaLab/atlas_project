...
initDir = rawPath + 'downstream/clustering/cancer/'
...
fig.write_image(figDir + 'cancer_metastasis_leiden.png')
fig.write_html(figDir + 'cancer_metastasis_leiden.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'cancer_metastasis_treatment.png')
fig.write_html(figDir + 'cancer_metastasis_treatment.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'cancer_metastasis_cellcycle.png')
fig.write_html(figDir + 'cancer_metastasis_cellcycle.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'cancer_metastasis_tumorstage.png')
fig.write_html(figDir + 'cancer_metastasis_tumorstage.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'cancer_metastasis_recurrence.png')
fig.write_html(figDir + 'cancer_metastasis_recurrence.html')
fig.show()
...
fig = px.parallel_categories(LeidenDF, 
                             ...
                             width=2000,height=700)
fig.write_image(figDir + 'cancer_metastasis_anatomical_location.png')
fig.write_html(figDir + 'cancer_metastasis_anatomical_location.html')
fig.show()
