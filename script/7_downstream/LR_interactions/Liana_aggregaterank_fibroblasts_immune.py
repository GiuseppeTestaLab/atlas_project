# Running Liana on fibroblasts and immune cells divided by treatment type and tissue type
...
adata = adata[(adata.obs['max'] == 'FibroblastsMSK') | (adata.obs['max'] == 'HematopoieticMSK')]
