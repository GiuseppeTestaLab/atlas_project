# Running Liana on endothelial and immune cells divided by treatment type and tissue type
...
outDir = '/group/testa/Project/OvarianAtlas/atlas_project/raw_data/downstream/LR_interactions/endothelial_immune/'
sc.settings.figdir = '/group/testa/Project/OvarianAtlas/atlas_project/plots_def/LR_interactions/endothelial_immune/'
...
adata = adata[(adata.obs['max'] == 'EndothelialMSK') | (adata.obs['max'] == 'HematopoieticMSK')]
