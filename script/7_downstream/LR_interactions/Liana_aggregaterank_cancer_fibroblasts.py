# Running Liana on cancer and fibroblasts divided by treatment type and tissue type
...
outDir = '/group/testa/Project/OvarianAtlas/atlas_project/raw_data/downstream/LR_interactions/cancer_fibroblasts/'
sc.settings.figdir = '/group/testa/Project/OvarianAtlas/atlas_project/plots_def/LR_interactions/cancer_fibroblasts/'
...
adata.obs.loc[adata.obs['max'] == "FibroblastsMSK", 'liana_categories'] = 'F_' + adata.obs['ontologies_from_seacells']
