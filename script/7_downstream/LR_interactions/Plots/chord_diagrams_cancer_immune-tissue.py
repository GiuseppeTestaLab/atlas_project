# Chord diagrams plotted for cancer-immune interactions
...
cmaps = ("Set3", personal_cmap, "magma", personal_cmap)         # colormap
...
#%%
## Load the data
adata = sc.read_h5ad(initDir + 'liana_aggregaterank_ascites.h5ad')
adata
adata.obs
...
#%%
## Load the data
adata = sc.read_h5ad(initDir + 'liana_aggregaterank_primary.h5ad')
adata
adata.obs
...
#%%
## Load the data
adata = sc.read_h5ad(initDir + 'liana_aggregaterank_naive.h5ad')
adata
adata.obs
...
#%%
## Load the data
adata = sc.read_h5ad(initDir + 'liana_aggregaterank_nact.h5ad')
adata
adata.obs
...
#%%
## Load the data
adata = sc.read_h5ad(initDir + 'liana_aggregaterank_cht.h5ad')
adata
adata.obs
