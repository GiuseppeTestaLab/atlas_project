...
outDir = "/group/testa/Project/OvarianAtlas/atlas_project/raw_data/original_counts/Regner2021/Adata/"
...
run = glob.glob(os.path.join(initDir, "HGSOC_tum/*"))
...
adata.write_h5ad(outDir + "regner2021_rawcounts.h5ad")

#Preprocessing

finalDir = "/group/testa/Project/OvarianAtlas/atlas_project/raw_data/original_anndata/Regner2021/"
...
adata.write(finalDir + "regner2021_filt_norm_nolog.h5ad")