...
for major_cell_type in major_cell_types:
    ...
    for tissue_file in tissues:
        ...
        adata_query_by_tissue_all[list(adata_query_by_tissue.keys())[0]] = adata_query_by_tissue[list(adata_query_by_tissue.keys())[0]]
        adata_ref_by_tissue_all[list(adata_ref_by_tissue.keys())[0]] = adata_ref_by_tissue[list(adata_ref_by_tissue.keys())[0]]
...
ranks.to_csv("enrichment/ranks_by_tissue_tissue.csv", index=False)
...
#%%
g_prof.to_csv("enrichment/enrichment_tissue.csv")
# %%
summary_data = []
