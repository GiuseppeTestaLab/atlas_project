...
for major_cell_type in major_cell_types:
    ...
    for tissue in tissues:
        ...
        adata_path = ooseDir +  f'integrated_query_seacells_scarches_tissuetreat_{major_cell_type}_{tissue}_raw_corrected.h5ad'
        ...
        # Save adata
        adata.write_h5ad(ooseDir + f'integrated_query_seacells_scarches_tissuetreat_predicted_cellstates_{major_cell_type}_{tissue}corrected_raw.h5ad')
