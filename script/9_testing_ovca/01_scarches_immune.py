...
initDir = rawPath + 'metacells_step0/immune/'
outDir = rawPath + 'integration/metacells/immune_testing_ovca/'
ooseDir = rawPath + 'out_of_sample_extension/immune_testing_ovca/'
...
sc.settings.figdir = figPath + "oose/immune_testing/"

## Loading reference data and creating integration model
#%%
ad = sc.read_h5ad("/group/testa/Project/OvarianAtlas/atlas_project/raw_data/metacells_backup/metacells/immune/" + "seacells_hdg_patients.h5ad")
...
major_cell_type = "HematopoieticMSK"
...
#%%
adata_target_path = "/group/testa/Project/OvarianAtlasTestStep0/raw_data/metacells_step0/immune/" + 'seacells_hdg_patients.h5ad'
