...
plt.bar(
    r,
    cell_type3_percent,
    bottom=cell_type1_percent + cell_type2_percent,
    color="#B3E6B5",
    edgecolor="white",
    width=barWidth,
    label="Fibroblasts",
...
plt.bar(
    r,
    cell_type4_percent,
    bottom=cell_type1_percent + cell_type2_percent + cell_type3_percent,
    color="#9addfb",
    edgecolor="white",
    width=barWidth,
    label="Immune cells",
