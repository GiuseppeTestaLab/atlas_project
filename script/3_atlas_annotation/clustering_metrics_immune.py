...
# Adjusted Rand Index: 0.08593025884752113
# Adjusted Mutual Information: 0.2700190879590837
# Fowlkes-Mallows Index: 0.11951472954651562

#%%
# Save the results to a file
finalDir = '/group/testa/Project/OvarianAtlas/atlas_project/raw_data/atlas_annotation/'

with open('clustering_metrics_immune.txt', 'w') as file:
