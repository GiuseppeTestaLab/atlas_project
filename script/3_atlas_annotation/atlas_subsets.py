...
dir = '/group/testa/Project/OvarianAtlas/atlas_project/raw_data/atlas_annotated/'

adata = sc.read(dir + 'atlas_embeddings_cell_labelled.h5ad')
...
adata_cancer.write_h5ad(dir + 'atlas_cancer_filt_norm_nolog.h5ad')
...
adata_immune.write_h5ad(dir + 'atlas_immune_filt_norm_nolog.h5ad')
...
adata_fibro.write_h5ad(dir + 'atlas_fibroblast_filt_norm_nolog.h5ad')
...
adata_endo.write_h5ad(dir + 'atlas_endothelial_filt_norm_nolog.h5ad')