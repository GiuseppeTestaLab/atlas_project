...
palette_max = {
    "HematopoieticMSK": "#9addfb",
    "CancerMSK": "#F4BBC9",
    "FibroblastsMSK": "#B3E6B5",
    "EndothelialMSK": "#FC5A50",
}
...
## Plot UMAPs
sc.pl.umap(
    adata, color=["max"], palette=palette_max, frameon=False, save="_main_celltypes.png"
)
sc.pl.umap(
    adata,
    color=["ontologies_from_seacells"],
    frameon=False,
    save="_ontologies_from_seacells.png",
)
sc.pl.umap(
    adata, color=["tissue"], palette=palette_tissue, frameon=False, save="_tissue.png"
)
sc.pl.umap(adata, color=["treatment"], frameon=False, save="_treatment.png")
sc.pl.umap(
    adata, color=["anatomical_location"], frameon=False, save="_anatomical_location.png"
)
