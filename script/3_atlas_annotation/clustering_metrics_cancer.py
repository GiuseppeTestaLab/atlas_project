...
# Adjusted Rand Index: 0.7104931691332846
# Adjusted Mutual Information: 0.8760089090900212
# Fowlkes-Mallows Index: 0.7270238761614213

#%%
# Save the results to a file
finalDir = '/group/testa/Project/OvarianAtlas/atlas_project/raw_data/atlas_annotation/'

with open('clustering_metrics_cancer.txt', 'w') as file:
