...
adata_cancer.write(initDir + 'longitudinal_adata_cancer.h5ad')
...
#%%
filtered_df = dispersion_table[dispersion_table > 1.35].dropna(how='all')  # 5196 genes
...
#%%
hdg_table.to_csv(dir + 'atlas_hdg_common_dispersion_patients_cancer_longitudinal.csv')

#%%
hdg_true = pd.DataFrame(index=list_of_genes)
hdg_true['highly_variable'] = "True"
hdg_true.to_csv(dir + 'atlas_hdg_dispersion_patients_cancer_longitudinal.csv')
